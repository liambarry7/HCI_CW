...
disasters.push(warzone);
disasters.push(hurricane);
disasters.push(placeholder);

const unusedDisasters = ["tsunami", "flood", "wildfire", "industrialAccident", "publicHealthEmergencies"];
